...
# 1. LOAD DATA
# =====================================================
nodes_df = pd.read_csv("/content/storage_nodes.csv")
files_df = pd.read_csv("/content/data_blocks.csv")
...
plt.figure()
plt.bar(x - 0.3, baseline_load * 100, width=0.3, label="Baseline")
plt.bar(x, optimized_load * 100, width=0.3, label="PSO Optimized")
